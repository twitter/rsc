...
class ColdScalacScanner212 extends ScalacScanner212 {
  @Benchmark
...
class WarmScalacScanner212 extends ScalacScanner212 {
  @Benchmark
  def run(bs: BenchmarkState): Unit = {
    runImpl(bs)
  }
...
class HotScalacScanner212 extends ScalacScanner212 {
  @Benchmark
  def run(bs: BenchmarkState): Unit = {
    runImpl(bs)
  }
