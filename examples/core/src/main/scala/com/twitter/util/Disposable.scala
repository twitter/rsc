...
class DoubleTrouble(cause1: Throwable, cause2: Throwable) extends Exception {
  override def getStackTrace: _root_.scala.Array[_root_.java.lang.StackTraceElement] = cause1.getStackTrace
  override def getMessage: _root_.scala.Predef.String =
